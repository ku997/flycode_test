...
class EditPost extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.currentPost.userId != this.state.userId)
    ...
    return (
      <div className="editpost container">
        ...
        <textarea
          ...
          rows="10"
          className="editpost__text"
          defaultValue={this.state.body}
          type="text"
        />

        <div className="editpost__buttons">
          <button className="editpost__save" onClick={this.onSave}>
            Сохранить
          </button>
          <Link
            className="editpost__cancel"
...
export default withCookies(
  withRouter(connect(mapStateToProps, mapDispathToProps)(EditPost))
);
