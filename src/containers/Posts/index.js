          ...
          <div className="posts__inner">
            ...
            <PostList
              posts={this.props.posts.slice(
                this.props.currentPagPage * perPage,
                (this.props.currentPagPage + 1) * perPage
              )}
            />
            {Math.ceil(this.props.posts.length / perPage) > 1 && (
              <ReactPaginate
                previousLabel={"←"}
                nextLabel={"→"}
                pageCount={Math.ceil(this.props.posts.length / perPage)}
